...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -fgcse-las $(GRAPHITE)
...
KERNELFLAGS	= -O3 -munaligned-access -fgcse-lm -fgcse-sm -fsched-spec-load \
