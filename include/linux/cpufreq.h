...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_PEGASUSX)
extern struct cpufreq_governor cpufreq_gov_pegasusx;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_pegasusx)
#endif
